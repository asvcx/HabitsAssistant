...
public class InputDataByConsole extends InputData {
    ...
    public Optional<Instant> dateTimeInput(String inputMsg) {
        Optional<String> dateInput = stringInput(inputMsg,
                InputDataByConsole::isValidDate,
                (_) -> {},
    ...
    public Optional<String> enterUserName() {
        return stringInput(
                ...
                InputDataByConsole::isValidName,
                tempUser::setName,
    ...
    public Optional<String> enterUserEmail() {
        return stringInput(
                ...
                InputDataByConsole::isValidEmail,
                tempUser::setEmail,
    ...
    public Optional<String> enterUserPassword() {
        return stringInput(
                "Введите пароль",
                InputDataByConsole::isValidPassword,
