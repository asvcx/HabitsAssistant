...
public class Request {
    ...
    private <T> T executePostRequest(String path, String jsonInput, Class<T> responseClass) {
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            HttpURLConnection connection = createConnection(path, "POST", null, jsonInput);
    ...
    public boolean editUserData(String email, String token, String newName, String newEmail) {
        ...
        try {
            ...
            System.out.println("Не удалось создать json");
            return false;
        } catch (IOException e) {
            System.out.println(e.getMessage());
            return false;
    ...
    public boolean editUserPassword(String email, String token, String oldPassword, String newPassword) {
        ...
        try {
            ...
            System.out.println("Не удолось создать json");
            return false;
        } catch (IOException e) {
            System.out.println(e.getMessage());
            return false;
